...
| ------------------------ | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Frontend Performance Case Study** | Next.js banking dashboard optimized from a deliberately slow baseline — every change measured. Lighthouse 52→88, LCP −77%, TBT −94% | [GitHub](https://github.com/pravoobi/frontend-performance-case-study) · [Optimized Demo](https://frontend-performance-case-study-iota.vercel.app/) · [Baseline](https://frontend-performance-case-study-git-baseline-pravoobis-projects.vercel.app/) |
